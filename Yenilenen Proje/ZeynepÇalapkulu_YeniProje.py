...
import random
from Metro_Visualizer import draw_metro_graph
...
if __name__ == "__main__":
    ...
    cevap = input("Metro ağını görmek ister misiniz? Evet/Hayır \n").strip().lower()
    if cevap == "evet":
        plt.ion()
        draw_metro_graph()
        plt.show()
    ...
    while True:
        ...
        baslangic = input("Lütfen başlangıç istasyonunun kodunu girin: ")
        hedef = input("Lütfen hedef istasyonunun kodunu girin: ")
        ...
        if rota:
            ...
            metro.kırmızı_var_mı(rota,baslangic, hedef )
